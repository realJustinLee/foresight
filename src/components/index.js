...
export { default as Globes } from "./Globes";
...
export { default as Sankey } from "./charts/Sankey";
export { default as Imageslider } from "./charts/Imageslider";
/****Maps******/
export { default as MapPoint } from "./maps/MapPoint";
