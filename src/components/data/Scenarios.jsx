...
export const datasets = [
  {
    ...
    params: {
      ...
      watWithdrawByBasinRunoff: { units: "Water Withdrawals by Basin [Runoff] (km3)", group: "water", region: "glu", description: "" },
      watWithdrawByCrop: { units: "Water Withdrawals by Crop (km3)", group: "water", region: "region", description: "" },
      watWithdrawBySec: { units: "Water Withdrawals by Sector (km3)", group: "water", region: "region", description: "" },
      watWithdrawROGW: { units: "Water Withdrawals by Water Source [Runoff vs Groundwater] (km3)", group: "water", region: "glu", description: "" }
    },
    defaults: [
      "pop",
      "gdp",
